...
% - Histórico de RI, explicando o surgimento de métodos de RI com as bibliotecas
    ...
    No entanto, foi demonstrado por \citeonline{Cleverdon1959TESUIR} que um sistema baseado em palavras, como o sistema Uniterm proposto por \citeonline[p.~213--218]{Taube1952UTCI}, era tão bom e até melhor que outras abordagens clássicas, sendo a indexação por palavras posteriormente adotada pelos sistemas de RI \cite[p.~1446]{Sanderson2012THIRR}.
    ...
    \input{tex/textual/subsections/metodos-booleanos.tex}
    
    % -- A pesquisa de RI sendo desenvolvida, citar sistemas rankeados
    \input{tex/textual/subsections/ranqueamento.tex}
