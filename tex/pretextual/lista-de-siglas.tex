...
\nomenclature{núm.}{número}

\nomenclature{atrib.}{atributos}

\nomenclature{camadas.}{cam}

\nomenclature{dim.}{dimensões}

\nomenclature{esc.}{escondidas}

\nomenclature{CNN}{\textit{Convolutional Neural Network} (Rede Neural Convolucional)}

\nomenclature{ESRC}{\textit{ELMo Sentence Representation Convolutional}}
...
\nomenclature{RNG}{\textit{Random Number Generator} (gerador de números aleatórios)}
