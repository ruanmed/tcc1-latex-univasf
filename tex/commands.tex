...
\newcommand{\sourcecodenolinenos}[4]{
\begin{listing}[H]
	\refstepcounter{sourcecode}
	\captionof{listing}{#1 \label{cmd:#2}}
	\inputminted[bgcolor=bg, tabsize=4, breaklines]{#3}{codes/#4}
    \vspace{-0.5cm}
	\Ididthis
\end{listing}
}
...
% -----------------------------------------------------------------------------
% Comando para quebrar linhas com "underscore" \_
% ----------------------------------------------------------------------------- 
% \let\underscore{\discretionary{\_}{}{\_}}
% \renewcommand{\_}{\discretionary{\underscore}{\underscore}{\underscore}}
% \usepackage{underscore}
% \newcommand{\underscore}{\discretionary{\_-}{}{\_}}
% \newcommand{\underscore}{{\_}}
\let\svus\_
\newcommand{\underscore}{{\svus\allowbreak\hspace{0pt}}}

% \newcommand\myunderscoredword{\let\svus\_\def\_{\svus\allowbreak\hspace{0pt}}DB\_AUTHORPROF \let\_\svus}
% \def\_{\svus\allowbreak\hspace{0pt}}

% \usepackage{microtype}
% -----------------------------------------------------------------------------
% Comando fonte monoespaçada em urls.
% ----------------------------------------------------------------------------- 
\urlstyle{tt}
% -----------------------------------------------------------------------------
% Comando para número da última página
% ----------------------------------------------------------------------------- 
\usepackage{lastpage}
%--------------------------------------------------------------------------------
...
\RequirePackage{tikz}
\usepackage{tikz}
\usepackage[siunitx, RPvoltages]{circuitikz}			% para habilitar o desenho de circuitos
...
%--------------------------------------------------------------------------------
% Pacote simplecd para gerar capas dos CDs/DVDs
%--------------------------------------------------------------------------------
\usepackage{simplecd}
