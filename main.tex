...
% IDENTIFICAÇÃO
% ---------------------------------------------------------------------------
\titulo{Avaliação de técnicas de Recuperação de Informação como parâmetros em Mineração de Textos}
...
\selectlanguage{brazil}
	...
	\pretextual
		\input{tex/pretextual.tex}

	\textual
		\pagestyle{simple}
		\input{tex/textual/introducao.tex}
		\input{tex/textual/desenvolvimento.tex}
		\input{tex/textual/metodos.tex}
		\input{tex/textual/resultados.tex}
		\input{tex/textual/conclusao.tex}
